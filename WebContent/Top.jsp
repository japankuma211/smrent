...
<body>
	...
	<div id="logo">
		<a href="${contextPath}/member/Main.me"> 
			<img src="${contextPath}/img/RENT.jpg" alt="left" width="300" height="80" border="0"> 
		</a>
	</div>
		...
		<tr>
			...
			//login.jsp-> MemberFrontController.java-> CarMain.jsp-> Top.jsp 
				...
				if(id==null){
					%>                  
				<div id="login">
					<a href="${contextPath}/member/MemberLogin.me">login</a> | 
					<a href="${contextPath}/member/MemberJoin.me">join</a>
				</div>	
					<%
				}else{//세션값이 있으면 -> MemberFrontController서블릿에.. 로그아웃 | 회원가입 처리 요청
					%>
				<div id="login">
					<%=id %>님 로그인중 | <a href="${contextPath}/member/MemberLogout.me">logout</a> 
					 		 <%--  <a href="${contextPath}/member/MemberJoin.me">join</a> --%>
				</div>	
				<%
				}
	...
	<table width="1000" background="${contextPath}/img/aa.jpg" height="5">
		<tr>
			 ...
			 <%-- 	<a href="${contextPath}/CarMain.jsp?center=CarReservation.jsp"> --%>
			 	<a href="${contextPath}/product/CarReservation.do">
			 		<img alt="" src="${contextPath}/img/bb.jpg" border="0"> <!-- 예약하기 메뉴 -->
			 	</a>
			 </td>	
			 <td align="center" bgcolor="red">
			 	<a href="${contextPath}/product/CarConfirm.do">
			 		<img alt="" src="${contextPath}/img/cc.jpg" border="0"> <!-- 예약확인 메뉴-->
			 	</a>
			 </td>
			 <td align="center" bgcolor="red">
			 	<a href="${contextPath}/pboard/BoardList.do"> <!-- 자유 게시판 컨트롤러 요청 -->
			 		<img alt="" src="${contextPath}/img/dd.jpg" border="0"> <!-- 자유게시판 메뉴-->
			 	</a>
			 </td>
			 <td align="center" bgcolor="red">
			 	<a href="${contextPath}/CarMain.jsp?center=CarEvent.jsp">
			 		<img alt="" src="${contextPath}/img/even.jpg" border="0"> <!-- 이벤트 메뉴-->
			 	</a>
			 </td>
			 <td align="center" bgcolor="red">
			 	<a href="#"><!-- 공지사항 게시판 컨트롤러 요청 -->
			 		<img alt="" src="${contextPath}/img/ee.jpg" border="0"> <!-- 고객 센터 메뉴 -->
			 	</a>
			 </td>	
		 </tr>
	</table>
