...
<body>
	<center>
		<img alt="" src="${contextPath}/img/cis.jpg" border="0"> <!-- <차량정보 보기> 이미지 적용 -->
						...
						<c:if test="${j%4 == 0}">
							<tr align="center">
								...
								<td><!-- 선택하는 자동차를 렌트하기위해...컨트롤러로 요청시 차량번호를 전달한다.  -->
									<a href="${contextPath}/product/CarInfoController.do?carno=${v.carno}">
										<img alt="" src="${contextPath }/img/${v.carimg}" border="0" width="220" height="180">
									</a><p/>
									차량명 : ${v.carname}<br/>
									대여금액 : ${v.carprice}
								</td>
