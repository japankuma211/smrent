...
<center>
	...
	<form action="${contextPath}/product/CarConfirmUpdateProcController.do?orderid=${vo.orderid}" method="post">
		<table width="1000" border="0" align="center">
			...
			<tr>
				...
				<td align="center">
					<input type="date" name="carbegindate" value="${vo.carbegindate }">
				</td>
			</tr>
			<tr>
